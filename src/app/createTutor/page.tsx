    ...
    return (
        <div className="max-w-lg mx-auto mt-8 p-6 bg-white rounded shadow">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <input type="number" placeholder="Rating" value={rating} onChange={e => setRating(Number(e.target.value))} className="w-full p-2 border rounded" />
                <input type="number" placeholder="User ID" value={userId} onChange={e => setUserId(Number(e.target.value))} className="w-full p-2 border rounded" />
                ...
                <button type="submit" disabled={loading} className={`bg-blue-600 text-white px-4 py-2 rounded ${loading ? "opacity-50 cursor-not-allowed" : ""}`}>
